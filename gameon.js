...
function animateRowMajor() {
    var road = getWidthOfCard("card1");
    var heightOfRow = getHeightOfCard("card1") / 10;

    document.getElementById('eyesCM').style.left = currentRMX + 'px';
    document.getElementById('eyesCM').style.top = currentRMY + 'px';
    currentRMX += 5;
    currentRMY += 0;
    if (currentRMX > road) {
        currentRMX = 0;
    ...
    setTimeout('animateRowMajor()', 100);
}
